...
<head>
    ...
    <link rel="stylesheet" href="http://res.layui.com/layui/dist/css/layui.css?t=1515376178738" media="all">
    <style>
        body{margin: 10px;}
...
<script src="http://res.layui.com/layui/dist/layui.js?t=1515376178738"></script>
<script>
    layui.config({
